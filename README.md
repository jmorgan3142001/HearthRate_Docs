# HearthRate Documentation

> Modern lead capture and tour management platform for real estate professionals

Welcome to the HearthRate public documentation. This repository contains user guides, API references, and integration documentation for HearthRate.
...
-   **Website:** https://hearthrate.app (coming soon)
-   **Support:** support@hearthrate.app
...
1. **Sign Up** - Create your free account at hearthrate.app
...
HearthRate provides a REST API for custom integrations:

```bash
# Example: Fetch your events
curl -H "Authorization: Bearer YOUR_TOKEN" \
  https://hearthrate.app/v1/events/
```
...
-   **Email Support:** support@hearthrate.app
-   **Documentation:** Browse our guides above
-   **Response Time:** Within 24 hours on business days

## Privacy & Security

HearthRate is GDPR and CCPA compliant:
...
-   Email us at support@hearthrate.app

## License

Copyright © 2025 HearthRate. All rights reserved.
