...
2. [Set Up Your First Event](#set-up-your-first-event)
3. [Generate QR Codes](#generate-qr-codes)
4. [Capture Your First Lead](#capture-your-first-lead)
5. [Create a Property Tour](#create-a-property-tour)
6. [Build a Decision Deck](#build-a-decision-deck)
...
1. From your dashboard, click **Start Kiosk**
2. Your perpetual event opens in a new tab
3. This is your default lead capture URL

### Customize Your Event (Optional)

1. Go to **Dashboard → Events**
2. Click on your perpetual event
...
QR codes let visitors quickly access your kiosk mode on their phones.
...
Your kiosk mode is where visitors sign in at open houses.
...
5. **You get notified** when a new lead signs in

### View Your Leads

1. Go to **Dashboard → Leads**
2. See all captured leads with scores
3. Filter by Hot/Warm/Cold
4. Export to CSV for your CRM
...
## Build a Decision Deck

Decision decks help clients compare properties side-by-side and model offers.
...
3. Enter details or select from recent tours
4. Add photos, notes, pros/cons
...
1. **Use QR codes everywhere** - Yard signs, flyers, business cards
2. **Customize your bio** - It shows on kiosk mode
3. **Set your timezone** - Ensures accurate tour times
4. **Enable notifications** - Get alerted for new leads
5. **Export regularly** - Back up your data to CSV
